...
public class AccountsController {
    ...
    public ResponseEntity<Object> transferFunds(@RequestBody @Valid TransactionDetails transactionDetails) {
        try {
            this.accountsService.transferFunds(transactionDetails);
